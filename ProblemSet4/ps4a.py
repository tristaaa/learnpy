...
def getWordScore(word, n):
    ...
    wordLen = len(word)
    for letter in word:
        totPoints += SCRABBLE_LETTER_VALUES[letter]
    wordScore = totPoints * wordLen
    if wordLen == n:
        wordScore +=50
    return wordScore
    ...
    while(calculateHandlen(hand) > 0):
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                print('"' + inputWord + '" earned', wordScore, 'points. Total:', totalScore, 'points \n' )
                # Update the hand 
